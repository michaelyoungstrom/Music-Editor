 ...
 * the name of the main type is for a model, we
 * parameterize this builder interface
 * by an unknown type.
 *
...
public interface CompositionBuilder<T> {
  /**
   * Constructs an actual composition, given the notes
   ...
   * @return
   */
  CompositionBuilder<T> addNote(int start, int end,
